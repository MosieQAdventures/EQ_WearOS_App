...
fun MacroNo6Screen(modifier: Modifier = Modifier,
    ...
    Scaffold() {
        ...
        TextOnTop(parameterName = "Macro 6")
...
private fun ValueText(precision: Int, suffix: String, arcUiState: ArcsUiState, arcsViewModel: ArcsViewModel) {
    var progress = arcsViewModel.getArc6Progress()
...
private fun Arc(modifier: Modifier = Modifier, arcsViewModel: ArcsViewModel, focusRequester: FocusRequester, arcUiState: ArcsUiState) {
    Scaffold() {
        ...
        var progress by remember { mutableStateOf(arcUiState.arcStateNo6) }
        ...
        Column(modifier = Modifier
            ...
            .onRotaryScrollEvent {
                ...
                arcsViewModel.changeArc6Value(progress)
