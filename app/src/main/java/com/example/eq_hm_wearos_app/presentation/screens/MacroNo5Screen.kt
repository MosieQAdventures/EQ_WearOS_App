...
@Composable
fun MacroNo5Screen(modifier: Modifier = Modifier,
    ...
    Scaffold() {
        ...
        TextOnTop(parameterName = "Macro 5")
...
private fun ValueText(precision: Int, suffix: String, arcUiState: ArcsUiState, arcsViewModel: ArcsViewModel) {
    var progress = arcsViewModel.getArc5Progress()
...
private fun Arc(modifier: Modifier = Modifier, arcsViewModel: ArcsViewModel, focusRequester: FocusRequester, arcUiState: ArcsUiState) {
    Scaffold() {
        ...
        var progress by remember { mutableStateOf(arcUiState.arcStateNo5) }
        ...
        Column(modifier = Modifier
            ...
            .onRotaryScrollEvent {
                ...
                arcsViewModel.changeArc5Value(progress)
