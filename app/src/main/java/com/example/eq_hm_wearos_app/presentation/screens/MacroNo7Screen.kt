...
@Composable
fun MacroNo7Screen(modifier: Modifier = Modifier,
    ...
    Scaffold() {
        ...
        TextOnTop(parameterName = "Macro 7")
...
private fun ValueText(precision: Int, suffix: String, arcUiState: ArcsUiState, arcsViewModel: ArcsViewModel) {
    var progress = arcsViewModel.getArc7Progress()
...
private fun Arc(modifier: Modifier = Modifier, arcsViewModel: ArcsViewModel, focusRequester: FocusRequester, arcUiState: ArcsUiState) {
    Scaffold() {
        ...
        var progress by remember { mutableStateOf(arcUiState.arcStateNo7) }
        ...
        Column(modifier = Modifier
            ...
            .onRotaryScrollEvent {
                ...
                arcsViewModel.changeArc7Value(progress)
