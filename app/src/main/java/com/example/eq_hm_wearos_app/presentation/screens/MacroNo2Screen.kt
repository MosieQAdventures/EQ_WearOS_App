...
@Composable
fun MacroNo2Screen(modifier: Modifier = Modifier,
    ...
    Scaffold() {
        ...
        TextOnTop()
        TitleAndValueText(title = "Macro", parameterName = "no 2", precision = 0, suffix = "%", arcUiState = arcUiState, arcsViewModel = arcsViewModel)
