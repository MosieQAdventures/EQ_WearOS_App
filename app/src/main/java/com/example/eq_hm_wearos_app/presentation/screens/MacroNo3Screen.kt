...
@Composable
fun MacroNo3Screen(modifier: Modifier = Modifier,
    ...
    Scaffold() {
        ...
        TextOnTop(parameterName = "Macro 3")
...
private fun ValueText(precision: Int, suffix: String, arcUiState: ArcsUiState, arcsViewModel: ArcsViewModel) {
    var progress = arcsViewModel.getArc3Progress()
...
private fun Arc(modifier: Modifier = Modifier, arcsViewModel: ArcsViewModel, focusRequester: FocusRequester, arcUiState: ArcsUiState) {
    Scaffold() {
        ...
        var progress by remember { mutableStateOf(arcUiState.arcStateNo3) }
        ...
        Column(modifier = Modifier
            ...
            .onRotaryScrollEvent {
                ...
                arcsViewModel.changeArc3Value(progress)
